    ...
    const projects = [
        {
            ...
            link: "https://iconnect.smsinfolink.com/",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            techStack: ["Next.js", "Node.js", "Tailwind CSS", "Supabase"],
            link: "https://admin-santeknath.vercel.app/",
        },
    ];

    return (
        <div
            className={`flex flex-col items-center justify-center py-20 relative w-full max-w-7xl 2xl:max-w-[1400px] mx-auto overflow-x-hidden transition-all duration-300 ${selectedProject ? 'z-50' : 'z-20'}`}
            id="projects"
        >
